      ...
      <Container>
        <div>
          <div className="flex flex-wrap justify-between items-center mx-auto py-4">
            ...
            <div
              id="mega-menu-full"
              className="items-center justify-between font-medium hidden w-full lg:flex lg:w-auto"
            >
              <ul
            ...
            <div className="flex items-center gap-6">
              <a href="#" className={`hidden lg:inline transition-all border px-6 py-2 hover:bg-primary hover:border-primary hover:text-white rounded-full ${color ? "border-gray-400 text-black" : (type === "blue" ? "border-gray-400 text-gray-900" : "border-gray-400 text-white")}`}>Login</a>
